...
class ControlePedido extends Page {
    ...
    */
    public static function getPedidos(){
        ...
        $codigoCliente = $_SESSION['pages']['usuario']['id'];
        ...
        while($pedido = $pedidos->fetchObject()){
            ...
            $tr .= View::render('pages/controlepedido/pedidos', [
        ...
        $content = View::render('pages/controlepedidos', [
            'tr' => $tr
        ]);
    ...
    public static function getPedidoItens($id){
        ...
        while ($item = $itens->fetchObject()){
            ...
            $tr .= View::render('pages/controlepedido/produtos', [
    ...
    public static function  getPedido($id){
        ...
        $content = View::render('pages/controlepedidoss', [
